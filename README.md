...
BTK pairs naturally with **[RTK (Rust Token Killer)](https://github.com/rtk-ai/rtk)** — the CLI proxy that compresses `git`, `cargo`, `npm`, and other dev tool output before it reaches your LLM.
